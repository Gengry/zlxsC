...
(
   ...
   order_type           int default 1 comment '1 订购单 2销售单',
...
(
   ...
   item_price           decimal(18,3) comment '单价',
   item_discount        decimal(18,2) comment '折扣',
   item_totle_price     decimal(18,3) comment '小计',
...
(
   ...
   storage_model        varchar(20) comment '线缆型号',
   ...
   storage_provider     varchar(30) comment '供应商',
   storage_update_time  datetime comment '更新时间',
   storage_house        varchar(30) comment '仓库id',
